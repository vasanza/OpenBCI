...
cv2.arrowedLine(my_img, (1540, 870),(1540, 760) ,(255, 255, 255), 3)

cv2.imshow('Window', my_img)
cv2.waitKey(0)
cv2.destroyAllWindows()
cv2.imwrite('RDF.jpg', my_img)